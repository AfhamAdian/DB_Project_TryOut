...
CREATE TABLE users
( 
    ID NUMBER GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1) CONSTRAINT USERS_PK PRIMARY KEY,
...
CREATE TABLE company 
(
    ID NUMBER GENERATED ALWAYS as IDENTITY(START with 20 INCREMENT by 1) CONSTRAINT COMPANY_PK PRIMARY KEY,
...
CREATE TABLE customer 
(
ID NUMBER GENERATED ALWAYS as IDENTITY(START with 21 INCREMENT by 1) CONSTRAINT CUSTOMER_PK PRIMARY KEY,
EMAIL VARCHAR2(50) UNIQUE NOT NULL,
PHONE_NUMBER NUMBER(15) UNIQUE NOT NULL,
...
CREATE TABLE admin 
(
ID NUMBER GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1) CONSTRAINT ADMIN_PK PRIMARY KEY,
FOREIGN KEY(ID) REFERENCES users(ID) ON DELETE CASCADE
);
...
CREATE TABLE locations
(
LOCATION_ID NUMBER GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1) CONSTRAINT LOCATIONS_PK PRIMARY KEY,
...
CREATE TABLE cars
(
MODEL_COLOR_ID NUMBER GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1) CONSTRAINT CARS_PK PRIMARY KEY,
...
CREATE TABLE showroom
(
SHOWROOM_ID NUMBER GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1) CONSTRAINT SHOWROOM_PK PRIMARY KEY,
...
CREATE TABLE cart
(
CART_ID NUMBER GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1) CONSTRAINT CART_PK PRIMARY KEY,
...
CREATE TABLE voucher
(
VOUCHER_NO NUMBER GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1) CONSTRAINT VOUCHER_PK PRIMARY KEY,
VOUCHER_NAME VARCHAR2(50) NOT NULL,
DISCOUNT VARCHAR2(20) NOT NULL,
VALIDITY_DATE DATE NOT NULL,
ADD_TYPE VARCHAR2(5) CHECK(ADD_TYPE IN ('AD','CO') )
);
...
(
    ID NUMBER GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1) CONSTRAINT ctt_pk PRIMARY KEY,
    COMPANY_ID NUMBER(15),
    TYPE_ID VARCHAR2(15),
