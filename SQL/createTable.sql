...
CREATE TABLE company 
(
    ID NUMBER GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1) CONSTRAINT COMPANY_PK PRIMARY KEY,
...
CREATE TABLE customer 
(
ID NUMBER GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1) CONSTRAINT CUSTOMER_PK PRIMARY KEY,
EMAIL VARCHAR2(50) UNIQUE NOT NULL,
PHONE_NUMBER NUMBER(15) UNIQUE NOT NULL,
